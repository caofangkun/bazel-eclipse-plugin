...
package com.github.caofangkun.bazelipse;
...
import com.github.caofangkun.bazelipse.command.BazelCommand;
import com.github.caofangkun.bazelipse.command.BazelCommand.BazelInstance;
...
public class Activator extends AbstractUIPlugin {
  ...
  // The plug-in ID
  public static final String PLUGIN_ID = "com.github.caofangkun.bazelipse.e4b"; //$NON-NLS-1$
  ...
  /**
   * List targets configure for <code>project</code>. Each project configured
   * for Bazel is configured to track certain targets and this function fetch
   * this list from the project preferences.
   */
  public static ImmutableList<String> getTargets(IProject project)
  ...
  /**
   * Return the {@link BazelInstance} corresponding to the given
   * <code>project</code>. It looks for the instance that runs for the workspace
   * root configured for that project.
   */
  public static BazelCommand.BazelInstance getBazelCommandInstance(
      IProject project)
    ...
    File workspaceRoot = new File(projectNode.get("workspaceRoot",
  ...
  public static void error(String message, Throwable exception) {
    plugin.getLog()
        .log(new Status(Status.ERROR, PLUGIN_ID, message, exception));
  }
}
